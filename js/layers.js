    ...
    infoboxes: {
        lore: {
            ...
            body() {
                ...
                If you want to check the changelog, hotkeys or modding tree version, click the info button!<br>
                If you want to see some useful tips or read the game lore, click the lore button! (Just remember that each layer will unlock new lore).<br>
...
addLayer("t", {
    ...
    upgrades: {
        ...
        32: {
            ...
            effectDisplay() { return "+" + format(upgradeEffect(this.layer, this.id)) + (upgradeEffect(this.layer, this.id).eq(2.5) ? " (hardcapped)" : "") }, // Add formatting to the effect
        },
...
addLayer("l", {
    ...
    upgrades: {
        11: {
            title: "Home Base",
            description: "Build a home base on the Moon, which boosts the Town base by the amount of Lunar Colonies",
            cost: new Decimal(1),
        ...
        32: {
            ...
            effect() {
                return player.l.buyables[11].add(tmp.n.buyables[11].freeLevels).max(1).log(1.5);
            },
            effectDisplay() { return format(upgradeEffect(this.layer, this.id)) + "x" }, // Add formatting to the effect
        },
        33: {
...
addLayer("o", {
    ...
    gainExp() { // Calculate the exponent on main currency from bonuses
        ...
        if (player.o.points.gte(5)) exp = exp.div(1.05);
        if (player.o.points.gte(10)) exp = exp.div(player.o.points.sub(8).times(0.05).add(1));
        ...
        if (player.o.points.gte(25)) exp = exp.div(player.o.points.sub(23).times(0.1).add(1));
    ...
    */
    ...
    upgrades: {
        ...
        32: {
            ...
            effect() {
                return new Decimal(3).pow(player.o.points);
            },
            effectDisplay() { return format(upgradeEffect(this.layer, this.id)) + "x" }, // Add formatting to the effect
...
// Make coin gain be boosted by time speed